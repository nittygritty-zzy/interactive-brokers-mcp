...
export const PlaceStockOrderZodSchema = z.object(PlaceStockOrderZodShape).refine((data) => {
...
export const PlaceOptionOrderZodSchema = z.object(PlaceOptionOrderZodShape).refine((data) => {
    if (data.orderType === "LMT" && data.price === undefined) {
        return false;
    }
    if (data.orderType === "STP" && data.stopPrice === undefined) {
